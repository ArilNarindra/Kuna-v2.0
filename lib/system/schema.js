module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['6285704026706', '6285815700861']
      if (!('msg' in setting)) setting.msg = 'Halo +tag '
      if (!isNumber(setting.style)) setting.style = 1
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/1cc2b51b7c07918ee93ec.jpg'
      if (!('link' in setting)) setting.link = 'https://whatsapp.com/channel/0029Vaf2svQAO7RCkEAArl1c'
   } else {
      global.db.data.setting = {
         ...
         owners: ['6285704026706', '6285815700861'],
         msg: 'Halo +tag',
         style: 1,
         cover: 'https://telegra.ph/file/1cc2b51b7c07918ee93ec.jpg',
         link: 'https://whatsapp.com/channel/0029Vaf2svQAO7RCkEAArl1c'
      }
   }
}